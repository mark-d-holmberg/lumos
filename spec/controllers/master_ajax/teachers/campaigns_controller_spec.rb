...
RSpec.describe MasterAjax::Teachers::CampaignsController, type: :controller do
  ...
  describe "GET new" do
    it "assigns a new campaign as @campaign" do
      xhr :get, :new, {teacher_id: @teacher.to_param}, valid_session
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Campaign" do
        expect {
          xhr :post, :create, {format: :js, teacher_id: @teacher.to_param, campaign: valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved campaign as @campaign" do
        xhr :post, :create, {format: :js, teacher_id: @teacher.to_param, campaign: invalid_attributes}, valid_session
        expect(assigns(:campaign)).to be_a_new(Campaign)
      end
